...
Java_dev_gophics_mirror_NativeSurface_acquire(JNIEnv *env, jobject thiz, jobject surface) {
    (void) thiz;
...
Java_dev_gophics_mirror_NativeSurface_release(JNIEnv *env, jobject thiz, jlong ptr) {
    (void) env;
    (void) thiz;
