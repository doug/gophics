...
Java_com_gophics_tally_NativeSurface_acquire(JNIEnv *env, jobject thiz, jobject surface) {
    (void) thiz;
...
Java_com_gophics_tally_NativeSurface_release(JNIEnv *env, jobject thiz, jlong ptr) {
    (void) env;
    (void) thiz;
