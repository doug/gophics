...
Java_dev_gophics_health_NativeSurface_acquire(JNIEnv *env, jobject thiz, jobject surface) {
    (void) thiz;
...
Java_dev_gophics_health_NativeSurface_release(JNIEnv *env, jobject thiz, jlong ptr) {
    (void) env;
    (void) thiz;
