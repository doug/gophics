...
// memoSpan is the geometry-affecting part of a layout.RichSpan (Color/Underline/
...
func (b *RichBox) Layout(cs layout.Constraints) geom.Size {
...
func (b *RichBox) AddHits(p geom.Pt, hits *[]layout.Hit) {
	if b.contains(p) {
...
func (b *RichBox) Semantics() layout.SemInfo {
	return layout.SemInfo{Role: layout.RoleText, Label: b.fullText()}
}
